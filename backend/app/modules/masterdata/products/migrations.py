...
def ensure_product_schema(connection: Connection) -> None:
    ...
    product_statements = {
        ...
        "updated_at": (
            "ALTER TABLE products ADD COLUMN updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP"
        ),
    }
    ...
    accessory_columns = {column["name"] for column in inspector.get_columns("product_accessories")}
