...
class SupplierInvoice(Base):
    ...
    purchase_invoice_notice_id: Mapped[str | None] = mapped_column(
        String(36),
        index=True,
        nullable=True,
    )
    purchase_invoice_notice_code: Mapped[str | None] = mapped_column(
        String(80),
        index=True,
        nullable=True,
    )
...
class PaymentRequest(Base):
    __tablename__ = "finance_payment_requests"
    ...
    supplier_invoice_no: Mapped[str] = mapped_column(String(120), index=True, nullable=False)
    supplier_id: Mapped[str | None] = mapped_column(String(36), index=True, nullable=True)
    supplier_name: Mapped[str] = mapped_column(String(240), index=True, nullable=False)
    purchase_contract_id: Mapped[str | None] = mapped_column(
        String(36),
    ...
    payment_type: Mapped[str] = mapped_column(String(40), index=True, nullable=False)
...
class PaymentAllocation(Base):
    ...
    payment_request_id: Mapped[str] = mapped_column(
        ForeignKey("finance_payment_requests.id"),
        index=True,
        nullable=False,
    )
    supplier_invoice_id: Mapped[str] = mapped_column(
